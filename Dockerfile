...
FROM --platform=linux/arm64 ghcr.io/hutchic-org/kong-openssl:1.2.12-aarch64-linux-musl as aarch64-linux-musl
FROM --platform=linux/arm64 ghcr.io/hutchic-org/kong-openssl:1.2.12-aarch64-linux-gnu as aarch64-linux-gnu
